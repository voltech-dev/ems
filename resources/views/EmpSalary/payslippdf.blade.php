...
<div style="padding:5px">
    ...
    <table width="100%">
        ...
        <tr>
            <td
                style="text-align: center;border-top: 1px solid #ccc; border-bottom: 1px solid #ccc;display: flex;justify-content: space-around;">
                Payslip for the month of {{ date('F , Y', strtotime($model->month))}}</td>

        </tr>
    </table>
    <table width="100%">
        <tr>
            <td width="43%" valign="top" style="border-right: 1px solid #ccc;">


                <table width="100%">

                    <tr>
                        <td style="border-bottom: 1px solid #ccc;font-weight: 700;" colspan="2">Employee Details</td>
                    ...
                    <tr>
                        <td>DOJ</td>
                        <td align="right">
                            {{ ($model->date_of_joining ? date('d/m/Y', strtotime($model->date_of_joining)) : '')}}</td>
                    </tr>
                    <tr>
                        <td>Month days</td>
            ...
            <td>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td width="30%" align="right" style="border-bottom: 1px solid #ccc;font-weight: 700;">Actual
                        </td>
                        <td width="40%" align="right" style="border-bottom: 1px solid #ccc;font-weight: 700;">Earnings
                        </td>
                    </tr>
                    <tr>
                        <td>Base Pay</td>
                    ...
                    <tr>
                        <td>HRA</td>
                        <td align="right">{{$actual->hra}}</td>
                        <td align="right">{{$model->hra}}</td>
                    </tr>
                    @endif
                    @if($model->conveyance_earning)
                    <tr>
                        <td>Conveyance</td>
                        <td align="right">{{$actual->conveyance}}</td>
                        <td align="right">{{$model->conveyance_earning}}</td>
                    </tr>
                    @endif
                    @if($model->medical_earning)
                    <tr>
                        <td>Spl. Allowance</td>
                        <td align="right">{{$actual->medical}}</td>
                        <td align="right">{{$model->medical_earning}}</td>
                    </tr>
                    @endif
                    @if($model->education_earning)
                    <tr>
                        <td>Spl. Allowance</td>
                        <td align="right">{{$actual->education}}</td>
                        <td align="right">{{$model->education_earning}}</td>
                    </tr>
                    @endif
                    @if($model->spl_allowance)
                    <tr>
                        <td>Spl. Allowance</td>
                        <td align="right">{{$actual->splallowance}}</td>
                        <td align="right">{{$model->spl_allowance}}</td>
                    </tr>
                    @endif
                    @if($model->over_time)
                    <tr>
                        <td>Over Time</td>
                        <td></td>
                        <td align="right">{{$model->over_time}}</td>
                    </tr>
                    @endif
                    @if($model->arrear)
                    <tr>
                        <td>Arrear</td>
                        <td></td>
                        <td align="right">{{$model->arrear}}</td>
                    </tr>
                    @endif
                    <tr>
                        <td colspan="3"> </td>
        ...
        <tr>
            <td>Insurance</td>
            <td align="right"></td>
            <td align="right">{{$model->insurance}}</td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td align="right"></td>
            <td align="right">{{$model->professional_tax}}</td>
        </tr>
        @endif
        @if($model->esi)
        <tr>
        ...
        <tr>
            <td>Advance</td>
            <td align="right"></td>
            <td align="right">{{$model->advance}}</td>
        </tr>
        @endif
        @if($model->tds)
        <tr>
        ...
        <tr>
            ...
            <td align="right"></td>
            <td align="right">{{$model->conveyance_allowance}}</td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td align="right"></td>
            <td align="right">{{$model->laptop_allowance}}</td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td align="right"></td>
            <td align="right">{{$model->travel_allowance}}</td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td align="right"></td>
            <td align="right">{{$model->mobile_allowance}}</td>
        </tr>
        @endif
        <tr>
            <td colspan="3"></td>
        ...
        <tr>
            <td colspan="3"><b>In Words: </b> {{$model->employee->getIndianCurrency($takehome)}} Only</td>
        </tr>
    </table>
    </td>
    </tr>
    ...
    <table width="100%">
        ...
        <tr>
            <td
                style="text-align: center;border-top: 1px solid #ccc; border-bottom: 1px solid #ccc;display: flex;justify-content: space-around;">
                This is a system generated payslip. Hence signature not required.</td>
