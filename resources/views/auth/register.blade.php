                                ...
                                <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    <label class="custom-control custom-checkbox">
                                                        ...
                                                        <span class="custom-control-label"><a
                                                                href="https://laravel.spruko.com/admitro/Vertical-IconSidedar-Light/terms"
                                                                class="text-white-80">Agree the Terms and
                                                                policy</a></span>
                                                    </label>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 text-center">
                                                        <a href="https://laravel.spruko.com/admitro/Vertical-IconSidedar-Light/forgot-password-2"
                                    ...
                                    <div class="text-center pt-4">
                                        <div class="font-weight-normal fs-16">You Already have an account <a
                                                class="btn-link font-weight-normal text-white-80"
                                                href="{{ route('login') }}">Login Here</a></div>
                                    </div>
                                </div>
