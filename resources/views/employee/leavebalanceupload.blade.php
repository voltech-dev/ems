...
<div class="grid grid-cols-1 md:grid-cols-2">
    <div class="page-leftheader">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="#">Leave Balance Template</a></li>
        </ol>                                                                                                                                                                                                                                                                                         
    </div>
</div>
@endsection
...
<div class="ml-1">
    <div class="mt-1 text-gray-600 dark:text-gray-400 text-sm ">
        ...
        @endif
        <form action="{{ url('/importleavebalancetemplate') }}" method="POST" role="form" enctype="multipart/form-data">
            @csrf
...
$('#download').click(function() {
  //  var mon = $('#sal_month').val();
    var pro = $('#project').val();
   // window.open("downloadappraisaltemplate?project=" + pro + "&month=" + mon);
   window.open("downloadleavebalancetemplate?project=" + pro);
});
</script>
@endpush