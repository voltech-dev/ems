...
<!--Bootstrap css -->
<link href="https://laravel.spruko.com/admitro/Vertical-IconSidedar-Light/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
...
<link href="https://laravel.spruko.com/admitro/Vertical-IconSidedar-Light/assets/plugins/select2/select2.min.css" rel="stylesheet" />

<!-- INTERNAL Fullcalendar css-->
<link href="https://laravel.spruko.com/admitro/Vertical-IconSidedar-Light/assets/plugins/fullcalendar/fullcalendar.css" rel='stylesheet' />
<link href="https://laravel.spruko.com/admitro/Vertical-IconSidedar-Light/assets/plugins/fullcalendar/fullcalendar.print.min.css" rel='stylesheet' media='print' />
								...
								<div class="col-lg-3">
									<div class="card-body p-0">
										...
										<div class="card-body">
											...
											<div class="mt-5">
												<a class="btn btn-primary" href="https://laravel.spruko.com/admitro/Vertical-IconSidedar-Light/#" data-toggle="modal" data-target="#modalSetSchedule"><i class="fe fe-plus"></i> Add New Event</a>
											</div>
										</div>
									</div>
								</div>
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="https://laravel.spruko.com/admitro/Vertical-IconSidedar-Light/calendar" id="mainFormCalendar" method="post" name="mainFormCalendar">
...
@push('scripts')
		...
		<script src="https://laravel.spruko.com/admitro/Vertical-IconSidedar-Light/assets/plugins/bootstrap/popper.min.js"></script>
		<script src="https://laravel.spruko.com/admitro/Vertical-IconSidedar-Light/assets/plugins/bootstrap/js/bootstrap.min.js"></script>

		<!-- INTERNAL Full-calendar js-->
		<script src="https://laravel.spruko.com/admitro/Vertical-IconSidedar-Light/assets/plugins/fullcalendar/moment.min.js"></script>
		<script src="https://laravel.spruko.com/admitro/Vertical-IconSidedar-Light/assets/plugins/fullcalendar/fullcalendar.min.js"></script>
		<script src="https://laravel.spruko.com/admitro/Vertical-IconSidedar-Light/assets/js/app-calendar-events.js"></script>
		...
		<script src="https://laravel.spruko.com/admitro/Vertical-IconSidedar-Light/assets/js/custom.js"></script>
				<!-- INTERNAL Select2 js -->
                <script src="https://laravel.spruko.com/admitro/Vertical-IconSidedar-Light/assets/plugins/select2/select2.full.min.js"></script>
