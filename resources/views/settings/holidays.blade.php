...
@endsection
<?php
$off = DB::table('project_details')->get();
?>
                        ...
                        <div class="col-lg-3">
                            <div class="card-body p-0">
                                ...
                                <div class="card-body">
                                    <nav class="crumbs">
                                        <ol>
                                            <li class="crumb"><a onclick="myFunction()">National Holiday</a>
                                                <ul id="myDIV">
                                                    <li>Republic Day</li>
                                            ...
                                            <li class="crumb"><a onclick="myFunction1()">State Holiday</a>
                                            <ul id="myDIV1">
                                                    <li>Pongal</li>
                                                    <li>Thiruvalluvar Day</li>
                                                    <li>Uzhavar Thirunal</li>
                                                    <li>Ramzan</li>
                                                    <li>Vinayagar Chaturthi</li>
                                                </ul>
                                            </li>
                                            <li class="crumb"><a onclick="myFunction2()">Weekly Off</a>
                                            <ul id="myDIV2">
                                                    <li>All Sundays</li>
                                            </ul>
                                            </li>
                                    ...
                                    <div class="mt-5">
                                        <a class="btn btn-primary"
                                            ...
                                            data-toggle="modal" data-target="#modal-view-event-add"><i
                                                    ...
                                                    <div class="form-group d-flex align-items-center">
                                                        <label class="custom-control custom-radio mr-4">
                                                            <input type="radio" class="custom-control-input"
                                                                name="check" value="all" checked>
                                                            <span class="custom-control-label">All</span>
                                                        </label>
                                                        <label class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input"
                                                                name="check" value="project">
                                                            <span class="custom-control-label">Project</span>
                                                        </label>
                                                    </div>
