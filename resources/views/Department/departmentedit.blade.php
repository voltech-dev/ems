    ...
    <div class="p-6">
        <div class="ml-1">
            <div class="mt-1 text-gray-600 dark:text-gray-400 text-sm">
                <form action="{{ url('/Department/departmentupdate/'.$model->id) }}" method="POST">
                    {{ csrf_field() }}

                    <h5><u>Department Edit</u></h5>
                    <div class="form-group row">
                        <label for="first_name" class="col-sm-2 form-label">Department Name</label>
                        <div class=" col-md-3">
                            <input type="text" name="dept_name" id="dept_name" class="form-control" value="{{$model->department_name}}">
                        </div>
