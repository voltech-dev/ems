    ...
    <div class="p-6">
        <div class="ml-1">
            <div class="mt-1 text-gray-600 dark:text-gray-400 text-sm">
                <form action="{{ url('/Project/statusupdate/'.$model->id) }}" method="POST">
                    {{ csrf_field() }}

                    <h5><u>Status Edit</u></h5>
                    <div class="form-group row">
                        <label for="first_name" class="col-sm-2 form-label">Status</label>
                        <div class=" col-md-3">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-1"></div>
                        <div class="col-md-2">
                            <a class="btn btn-dark" href="{{ url('/Project/statuslist') }}"><i
