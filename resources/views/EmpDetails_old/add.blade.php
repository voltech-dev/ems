...
<div class="row col" style="margin-left: 5px;">
    <ul class="nav">
        ...
        <li class="nav-item " style="background-color:#00a09d;border:1px solid white">
            <a style="width:180px;color:white;text-align:center" class="nav-link" href="#"><b>Certificate</b></a>
        </li>
            ...
            <form action="{{ route('empdetails.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class=" col-md-3">
                            <input type="text" name="address_1" id="address_1" class="form-control" value="">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class=" col-md-3">
                            <input type="text" name="address_3" id="address_3" class="form-control" value="">
                        </div>

                        <label for="address_4" class="col-sm-2 form-label">Locality/Area</label>
                        <div class=" col-md-3">
                            <input type="text" name="address_4" id="address_4" class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class=" col-md-3">
                            <input type="text" name="address_5" id="address_5" class="form-control" value="">
                        </div>

                        <label for="address_6" class="col-sm-2 form-label">District</label>
                        <div class=" col-md-3">
                            <input type="text" name="address_6" id="address_6" class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class=" col-md-3">
                            <input type="text" name="address_7" id="address_7" class="form-control" value="">
                        </div>

                        <label for="address_8" class="col-sm-2 form-label">Pincode</label>
                        <div class=" col-md-3">
                            <input type="text" name="address_8" id="address_8" class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group row">
